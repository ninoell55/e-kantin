...
class UserSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // ========================================================
        $admins = [
            ['name' => 'Administrator Utama', 'email' => 'admin@ekantin.test'],
            ['name' => 'Bendahara Sekolah (Admin 2)', 'email' => 'bendahara@ekantin.test'],
        ];
        ...
        // ========================================================
        $teachers = [
            ['id_number' => '19880412001', 'name' => 'Bu Afika, S.Pd.'],
            ['id_number' => '19850923002', 'name' => 'Pak Ahmad Joko, M.T.'],
            ['id_number' => '19921105003', 'name' => 'Bu Sindi Amalia, S.Kom.'],
            ['id_number' => '19800101004', 'name' => 'Pak Bambang Setiawan, M.Pd.'],
            ['id_number' => '19950718005', 'name' => 'Bu Jihan Nabila, S.T.'],
        ];
        ...
        // ========================================================
        $students = [
            ['id_number' => '222310123', 'name' => 'Muhammad Ridho (XI RPL 2)'],
            ['id_number' => '222310124', 'name' => 'Siswa Indah Lestari'],
            ['id_number' => '222310125', 'name' => 'Ferdy Arisandi (XI RPL 2)'],
            ['id_number' => '222310126', 'name' => 'Siti Syakila (XI RPL 2)'],
            ['id_number' => '222310127', 'name' => 'Bintang Ramadhan'],
        ];
