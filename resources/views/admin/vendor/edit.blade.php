        ...
        <form action="{{ route('admin.vendor.update', $vendor->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" value="{{ old('name', $vendor->name) }}" class="form-input"
                        required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="nominal_sewa"
                        value="{{ old('nominal_sewa', $vendor->shop->currentBill->amount ?? 0) }}" class="form-input"
                        required>
                </div>
                ...
                <div id="bukti_tf_container">
                    ...
                    <input type="file" name="payment_proof" class="form-input">
                ...
                <div class="form-group full-width">
                    ...
                    <input type="file" name="shop_logo" accept="image/jpg,image/jpeg,image/png" class="form-input"
...
@section('scripts')
    <script>
        document.getElementById('payment_method').addEventListener('change', function() {
            document.getElementById('bukti_tf_container').style.display = this.value === 'transfer' ? 'block' :
                'none';
        });
