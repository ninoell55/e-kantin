...
@section('styles')
    <style>
        ...
        .gridline {
            ...
            left: 0 !important;
            right: 0 !important;
            border-top: 1px dashed #f0f1f5 !important;
            z-index: 1 !important;
        ...
        .bar-fill {
            ...
            transition: height 0.8s cubic-bezier(0.25, 1, 0.5, 1) !important;
            position: relative !important;
        ...
        .vendor-table td {
            ...
            color: var(--navy) !important;
            border-bottom: 1px dashed #f0f1f5 !important;
...
@section('content')
    <div class="dashboard-container">
        ...
        <div style="margin-bottom: 24px;">
            <h1 style="font-size:22px; font-weight:700; color:var(--navy); margin:0 0 4px;">Hello, {{ Auth::user()->name }}!
                👋</h1>
            <p style="font-size:13px; color:var(--gray-400); margin:0;">Berikut adalah ringkasan performa e-kantin hari ini.
            </p>
        </div>
            ...
            <div class="stat-2x2-grid">
                ...
                <div class="stat-card">
                    <div class="stat-top">
                        ...
                        <a href="{{ route('admin.invoice.index') }}" class="stat-btn">
                ...
                <div class="stat-card">
                    <div class="stat-top">
                        ...
                        <a href="{{ route('admin.vendor.index') }}" class="stat-btn">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <polyline points="7 17 17 7 17 17" />
                                <polyline points="7 7 17 7" />
                            </svg>
                ...
                <div class="stat-card">
                    <div class="stat-top">
                        ...
                        <a href="{{ route('admin.category.index') }}" class="stat-btn">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <polyline points="7 17 17 7 17 17" />
                                <polyline points="7 7 17 7" />
                            </svg>
                ...
                <div class="stat-card">
                    <div class="stat-top">
                        ...
                        <a href="{{ route('admin.costumer.index') }}" class="stat-btn">
                            <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                                <polyline points="7 17 17 7 17 17" />
                                <polyline points="7 7 17 7" />
                            </svg>
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        ...
                        <div class="card-sub">Statistik Tahun {{ now()->year }}</div>
                    </div>
                    <a href="{{ route('admin.invoice.index') }}" class="card-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                            <polyline points="7 17 17 7 17 17" />
                            <polyline points="7 7 17 7" />
                        </svg>
                    ...
                    <div class="chart-container">
                        <div class="chart-y-axis">
                            @foreach ($ySteps as $step)
                                <span
                                    class="axis-val">{{ $step >= 1000000 ? number_format($step / 1000000, 1) . 'M' : number_format($step / 1000, 0) . 'K' }}</span>
                            @endforeach
                        </div>
                        <div class="chart-bars-wrapper">
                            ...
                            @foreach ($chartMonths as $i => $month)
                                ...
                                <div class="bar-col">
                                    <div class="bar-track">
                                        <div class="bar-fill" data-height="{{ max($pct, 4) }}"
                                            style="height:0%; background:#6b8afc !important;">
                                            <div class="bar-tooltip">Rp {{ number_format($chartData[$i], 0, ',', '.') }}
                                            </div>
                                        </div>
                                    </div>
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        ...
                        <div class="card-sub">{{ count($vendors ?? []) }} vendor terdaftar</div>
                    </div>
                    <a href="{{ route('admin.vendor.index') }}" class="card-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                            <polyline points="7 17 17 7 17 17" />
                            <polyline points="7 7 17 7" />
                        </svg>
                            ...
                            @forelse($vendors ?? [] as $vendor)
                                @php
                                    ...
                                    if (
                                        $bs === 'unpaid' &&
                                        $bill &&
                                        now()->gt(\Carbon\Carbon::parse($bill->due_date))
                                    ) {
                                        $bs = 'overdue';
                                    }
                                @endphp
                                <tr>
                                    <td>
                                        ...
                                        <div style="font-size:11px; color:var(--gray-400); margin-top:2px;">
                                            {{ $vendor->shop->name ?? '-' }}</div>
                                    </td>
                                    <td style="font-weight:600; color:var(--navy);">Rp
                                        {{ number_format($bill->amount ?? 0, 0, ',', '.') }}</td>
                                    <td><span class="status-pill status-{{ $bs }}">{{ strtoupper($bs) }}</span>
                                    </td>
                                </tr>
                            @empty
                                <tr>
                                    <td colspan="3"
                                        style="text-align:center; padding:24px; color:var(--gray-400); font-size:13px;">
                                        Belum ada vendor</td>
                                </tr>
                            @endforelse
                        </tbody>
            ...
            <div class="card">
                <div class="card-header">
                    <div>
                        ...
                        <div class="card-sub">Ringkasan semua tagihan</div>
                    </div>
                    <a href="{{ route('admin.invoice.index') }}" class="card-btn">
                        <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5">
                            <polyline points="7 17 17 7 17 17" />
                ...
                <div class="card-body">
                    @php
                        ...
                        $oc = $overdueCount ?? 0;
                        $tot = $pc + $uc + $oc ?: 1;
                        $pPct = round(($pc / $tot) * 100);
                        $uPct = round(($uc / $tot) * 100);
                        $oPct = round(($oc / $tot) * 100);
                        $r = 60;
                        $cx = 80;
                        $cy = 80;
                        $circ = 2 * M_PI * $r;
                        ...
                        <div class="donut-svg-wrap">
                            <svg width="160" height="160" viewBox="0 0 160 160">
                                <circle cx="{{ $cx }}" cy="{{ $cy }}" r="{{ $r }}"
                                    fill="none" stroke="#f0f1f5" stroke-width="28" />
                                <circle cx="{{ $cx }}" cy="{{ $cy }}" r="{{ $r }}"
                                    fill="none" stroke="#6b8afc" stroke-width="28"
                                    stroke-dasharray="{{ $pD }} {{ $circ - $pD }}" stroke-dashoffset="0"
                                    transform="rotate(-90 {{ $cx }} {{ $cy }})" />
                                <circle cx="{{ $cx }}" cy="{{ $cy }}" r="{{ $r }}"
                                    fill="none" stroke="#facc15" stroke-width="28"
                                    stroke-dasharray="{{ $uD }} {{ $circ - $uD }}"
                                    stroke-dashoffset="{{ -$pD }}"
                                    transform="rotate(-90 {{ $cx }} {{ $cy }})" />
                                <circle cx="{{ $cx }}" cy="{{ $cy }}" r="{{ $r }}"
                                    fill="none" stroke="#f87171" stroke-width="28"
                                    stroke-dasharray="{{ $oD }} {{ $circ - $oD }}"
                                    stroke-dashoffset="{{ -$pD - $uD }}"
                                    transform="rotate(-90 {{ $cx }} {{ $cy }})" />
                            </svg>
                        ...
                        <div class="donut-legend">
                            <div class="legend-row">
                                <div class="legend-left">
                                    <div class="legend-dot" style="background:#6b8afc;"></div><span
                                        class="legend-lbl">Lunas</span>
                                </div>
                                <span class="legend-val">{{ $pPct }}%</span>
                            </div>
                            <div class="legend-row">
                                <div class="legend-left">
                                    <div class="legend-dot" style="background:#facc15;"></div><span
                                        class="legend-lbl">Menunggu</span>
                                </div>
                                <span class="legend-val">{{ $uPct }}%</span>
                            </div>
                            <div class="legend-row">
                                <div class="legend-left">
                                    <div class="legend-dot" style="background:#f87171;"></div><span
                                        class="legend-lbl">Overdue</span>
                                </div>
