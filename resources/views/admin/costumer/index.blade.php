            ...
            <tbody>
                @forelse($customers as $index => $customer)
                    <tr>
                        ...
                        <td class="center td-muted">
                            {{ \Carbon\Carbon::parse($customer->created_at)->translatedFormat('d M Y') }}</td>
                        <td class="center">
                            <div class="action-group">
                                ...
                                <button class="btn-action btn-ban" data-id="{{ $customer->id }}"
                                    data-name="{{ $customer->name }}" onclick="openDeleteModal(this)">
                                    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div class="modal">
            <div class="modal-body">
                ...
                <div class="confirm-text">
                    <h3>Ban Customer?</h3>
                    <p>Kamu yakin ingin menghapus<br><strong id="delete-name"></strong>?<br>Tindakan ini tidak dapat
                        dibatalkan.</p>
                </div>
            </div>
...
@section('scripts')
    <script>
        function openDeleteModal(btn) {
            ...
            document.getElementById('delete-form').action = '/admin/costumer/' + btn.getAttribute('data-id') + '/ban';
